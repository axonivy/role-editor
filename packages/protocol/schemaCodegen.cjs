...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/master/lastSuccessfulBuild/artifact/workspace/ch.ivyteam.ivy.user.role.lsp.schema/target/schema/role/14.0.0/roles-tsgen.json';
